export default {
  ...
  // 网站描述
  Description: 'Aholococo的个人博客,分享技术、编程语言、生活日常等内容.',
  // 网站作者
  Author: 'Aholicoco',
  // 作者头像
  Avatar: 'https://q1.qlogo.cn/g?b=qq&nk=2726239587&s=640',
  // 网站座右铭
  Motto: '运气是计划之外的东西.',
  // Cover 网站缩略图
  ...
  WebSites: [
    // 仅支持 SVG 且 SVG 需放在 public/assets/images/svg/ 目录下，填入文件名即可 <不需要文件后缀名>（封装了 SVG 组件 为了极致压缩 SVG）
    // 建议使用 https://tabler.io/icons 直接下载 SVG
    { text: 'Github', link: 'https://github.com/Aholicoco', icon: 'WebSite_github' },
